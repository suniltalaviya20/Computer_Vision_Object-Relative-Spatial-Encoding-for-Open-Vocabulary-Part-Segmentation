...
for object_id, (object_name, part_names) in PARTS_BY_OBJECT.items():
    ...
    for part_name in part_names:
        ...
        if object_name in UNSEEN_OBJECT_NAMES:
            part["evaluation_split"] = "unseen"
        else:
            part["evaluation_split"] = "seen"

        PART_CATEGORIES.append(part)
...
def get_part_category(part_id):
    if part_id < 0 or part_id >= len(PART_CATEGORIES):
