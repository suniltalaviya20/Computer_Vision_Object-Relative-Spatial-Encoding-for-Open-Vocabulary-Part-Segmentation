...
These models come from the completed corrected experiments in
...
metrics, plots, and completion data remain under
`training_results_corrected/` and are not duplicated here.
