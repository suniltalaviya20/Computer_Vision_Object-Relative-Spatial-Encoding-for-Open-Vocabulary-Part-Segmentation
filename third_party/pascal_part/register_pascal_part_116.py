...
OBJ_EVAL_BASE_CLASS_NAMES = [
    c for i, c in enumerate(OBJ_EVAL_CLASS_NAMES) if c not in ["bird", "car", "dog", "sheep", "motorbike"]
]
...
def _get_voc_obj_part_meta(cat_list, obj_list):
    ret = {
        ...
        "obj_eval_classes": OBJ_EVAL_CLASS_NAMES,
        "obj_eval_base_classes": OBJ_EVAL_BASE_CLASS_NAMES,
...
def register_pascal_part_116(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ...
        MetadataCatalog.get(all_name).set(
            ...
            obj_evaluation_set={
                "base": [
                    meta["obj_eval_classes"].index(n) for n in base_meta["obj_eval_base_classes"]
                ]
            },
            trainable_flag=[
